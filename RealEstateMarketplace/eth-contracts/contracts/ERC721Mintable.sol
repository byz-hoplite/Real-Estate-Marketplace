...
contract Ownable {
    ...
    modifier onlyOwner {
        require(msg.sender == _owner,"Only to be called by owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(msg.sender == tx.origin, "Invalid Address");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to!=owner,"given address not equated to owner of tokenId");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(isApprovedForAll(owner, msg.sender) == true || owner == msg.sender,
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        "address is not owner of given token");

        // TODO: require token is being transfered to valid address
        require(to == _tokenApprovals[tokenId], "address is invalid");
...
//      -calls the superclass mint and setTokenURI functions
    ...
    contract RealEstateToken is ERC721Metadata("REToken","RET","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
